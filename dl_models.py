...
class Interpret:
    ...
    def debug(self,idx):
        assert(self.ds[idx][2] == self.y[idx])
        print(f'y = {self.y[idx]}')
        print(f'pred = {self.pred[idx]}')
        print(f'loss = {self.loss[idx]}')
        print(f'act = {self.act[idx]}')
        print(f'prob = {self.prob[idx]}')
        display(self.ds[idx][0])
        display(self.ds[idx][1])
